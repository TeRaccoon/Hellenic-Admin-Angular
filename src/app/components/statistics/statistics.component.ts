...
export class StatisticsComponent {
  ...
  async buildCharts() {
    ...
    this.averageOrderValueChartOptions = this.statisticsService.getLineChartOptions(0.3, "Order Value (£)", "Date", false);
    ...
    this.totalOrdersChartOptions = this.statisticsService.getLineChartOptions(0.3, "Order Amount", "Date", false);
    ...
    let barChartDataset = this.statisticsService.getBarChartData(chartData.data, "Total Sales", ['rgb(0, 140, 255)'], 5, []);
    
    this.topSellingProductsChartData = {labels: barChartDataset.labels, datasets: [barChartDataset.datasets]};
    this.topSellingProductsChartOptions = this.statisticsService.getBarChartOptions("dunno", "dunno", false, false);
  }
}
